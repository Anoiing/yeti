...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.getProfile = getProfile;exports.getHistoryToday = getHistoryToday;exports.login = login;exports.register = register;exports.getTabMenus = getTabMenus;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 19));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var regRequest = function regRequest(url, params) {return new Promise(function (resolve, reject) {
    uni.request({
      url: url,
      data: params,
      success: function success(_ref) {var data = _ref.data;return resolve(data);},
      fail: function fail(res) {return reject(res);} });

  });};

// 获取配置概要
function getProfile() {return _getProfile.apply(this, arguments);}



// 历史上的今天
function _getProfile() {_getProfile = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:return _context.abrupt("return", regRequest('https://chao.fun/api/get_profile'));case 1:case "end":return _context.stop();}}}, _callee);}));return _getProfile.apply(this, arguments);}function getHistoryToday(_x) {return _getHistoryToday.apply(this, arguments);}



// 用户登录
function _getHistoryToday() {_getHistoryToday = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(params) {return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:return _context2.abrupt("return", regRequest('https://v.juhe.cn/todayOnhistory/queryEvent.php', params));case 1:case "end":return _context2.stop();}}}, _callee2);}));return _getHistoryToday.apply(this, arguments);}function login(_x2) {return _login.apply(this, arguments);}



// 注册新用户
function _login() {_login = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3(params) {return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:return _context3.abrupt("return", regRequest('https://chao.fun/api/login', params));case 1:case "end":return _context3.stop();}}}, _callee3);}));return _login.apply(this, arguments);}function register(_x3) {return _register.apply(this, arguments);}



// 获取Tab菜单
function _register() {_register = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4(params) {return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:return _context4.abrupt("return", regRequest('https://chao.fun/api/register', params));case 1:case "end":return _context4.stop();}}}, _callee4);}));return _register.apply(this, arguments);}function getTabMenus() {return _getTabMenus.apply(this, arguments);}function _getTabMenus() {_getTabMenus = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee5() {return _regenerator.default.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:return _context5.abrupt("return",
            regRequest('https://chao.fun/api/get_menu'));case 1:case "end":return _context5.stop();}}}, _callee5);}));return _getTabMenus.apply(this, arguments);}
